...
walls2 = [
    ...
    pygame.Rect(60, 410, 10, 180),# Third down
    ...
    pygame.Rect(290, 160, 190, 10),
    pygame.Rect(290 , 160 , 10, 300),
    pygame.Rect(120, 460, 180, 10),
    pygame.Rect(120, 460, 10, 130),
    pygame.Rect(230 , 220, 10, 200),
...
def title_screen():
    while True:
        screen.fill(BLACK)
        display_message(screen, "Press Enter to Start", WHITE, 0,0)
        pygame.display.flip()
    ...
    while running:
        ...
        if game_over:
            if win:
                ...
                screen.fill(BLACK)
                display_message(screen, "You Lose", RED)
        ...
        if win:
            screen.fill(BLACK)
            display_message(screen, "CREATED BY SARAN", GREEN,0,100)
            display_message(screen, "SHIVEN, SHREY", GREEN,0,200)
        else:
            screen.fill(BLACK)
            display_message(screen, "TRY AGAIN?", RED,0,100)
